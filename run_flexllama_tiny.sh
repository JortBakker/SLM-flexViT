#!/bin/bash
#SBATCH --job-name=flexllama_tiny
#SBATCH --nodes=1
...
#SBATCH --time=2:00:00
#SBATCH --mem=0
#SBATCH --output=logs/flexllama_tiny_%j.out
#SBATCH --error=logs/flexllama_tiny_%j.err
...
srun python3 run_experiment.py run flexllama,fineweb.tiny
