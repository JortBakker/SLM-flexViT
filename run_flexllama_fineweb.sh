#!/bin/bash
#SBATCH --job-name=flexllama_fineweb
#SBATCH --nodes=1
...
#SBATCH --mem=0
#SBATCH --output=logs/flexllama_fineweb_%j.out
#SBATCH --error=logs/flexllama_fineweb_%j.err
...
srun python3 run_experiment.py run flexllama,fineweb.3levels
